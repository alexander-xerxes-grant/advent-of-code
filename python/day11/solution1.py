...
def decide_monkey(input_monkey: dict) -> int:
    ...
    for item in input_monkey["items"]:
        new_worry_score = calculate_worry(
            item, input_monkey["operand"], input_monkey["operation_value"]
        )
        ...
        output_monkey.append(
            {"item": new_worry_score, "output_monkey": resulting_monkey}
        )
